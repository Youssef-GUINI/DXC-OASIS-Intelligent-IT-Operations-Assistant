...
export default function LoginPage() {
  ...
  if (user) return <Navigate to="/linux/dashboard" replace />;
      ...
      <div className="relative hidden flex-col justify-between overflow-hidden bg-canvas p-12 lg:flex">
        ...
        <div className="relative max-w-md">
          <h1 className="text-[32px] font-semibold leading-tight tracking-tight text-ink-900">
            A calm, intelligent workspace for Linux operations.
          </h1>
          <p className="mt-4 text-[15px] leading-relaxed text-ink-500">
            CPU, RAM, disk, services and network diagnostics in one place, with OASIS ready to guide each incident.
          </p>
        </div>

        <p className="relative text-[13px] text-ink-400">
          DXC OASIS · Linux Operations workspace
        </p>
      </div>
      ...
      <div className="flex items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-1.5 text-sm text-ink-500">
            Welcome back. Sign in to reach your Linux workspace.
          </p>
